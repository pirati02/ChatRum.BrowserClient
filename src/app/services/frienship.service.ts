...
export class FriendshipService {
  ...
  private friendRequestReceivedSubject = new BehaviorSubject<{ fromPeerId: Peer, toPeerId: Peer } | null>(null);
  private friendRequestAcceptedSubject = new BehaviorSubject<{ fromPeerId: Peer, toPeerId: Peer } | null>(null);
  ...
  startConnection(accountId: string) {
    ...
    this.hubConnection.on('FriendRequestReceived', (fromPeerId: Peer, toPeerId: Peer) => {
      this.friendRequestReceivedSubject.next({fromPeerId, toPeerId});
    });

    this.hubConnection.on('FriendRequestAccepted', (fromPeerId: Peer, toPeerId: Peer) => {
